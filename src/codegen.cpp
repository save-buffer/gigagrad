...
namespace gigagrad
{
    namespace codegen
    {
            ...
            size_t max_seen_size_elts)
        {
            ...
            return f.Unary(u.type, x, node.dtype());
        }
            ...
            size_t max_seen_size_elts)
        {
            ...
            return f.Binary(b.type, x, y, node.dtype());
        }
        ...
        void CodegenNode(Program &prog, GraphNodeHandle node, std::optional<size_t> output_buffer)
        {
            ...
            else
            {
                ...
                // const NumericDataType &data = node.dtype();
    ...
    CompiledTensor GraphNodeHandle::Compile(std::unique_ptr<codegen::Backend> backend) const
    {
        ...
        result.data = reinterpret_cast<double *>(backend->InitBuffers());
