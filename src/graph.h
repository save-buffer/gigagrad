...
namespace gigagrad
{
    ...
    struct GraphNodeHandle
    {
        ...
        const NumericDataType &dtype() const;
    ...
    {
        double *data = nullptr;
        NumericDataType dtype = NumericDataType::FLOAT32;
    };
    ...
    struct Graph
    {
        GraphNodeHandle Immediate(double imm);
        GraphNodeHandle AddInput(Shape shape, NumericDataType dtype = NumericDataType::FLOAT32);
        GraphNodeHandle AddInput(dim_t dim, NumericDataType dtype = NumericDataType::FLOAT32);

        GraphNodeHandle AddNode(Tensor tensor, Shape shape, NumericDataType dtype);
    ...
    namespace nn
    {
        ...
        struct Module
        {
            ...
            GraphNodeHandle AddWeight(Shape shape, NumericDataType dtype = NumericDataType::FLOAT32);
            GraphNodeHandle AddWeight(dim_t dim, NumericDataType dtype = NumericDataType::FLOAT32);
